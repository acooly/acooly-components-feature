<div align="center">
    <table class="tableForm" width="100%">
        ...
        <tr>
            <th>请求参数：</th>
            <td>
                <div style="word-wrap:break-word;max-width:550px" id="manage_ologEntity_show_parameter_container">${ologEntity
                .requestParameters}</div>
            </td>
        </tr>
        <tr>
            <th>操作结果：</th>
            <td>${ologEntity.operateResult}</td>
        </tr>
