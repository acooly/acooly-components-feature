<div class="easyui-layout" data-options="fit : true,border : false">
    ...
    <form id="manage_smsSendLog_searchform" class="form-inline ac-form-search" onsubmit="return false">
                    ...
                    <div class="form-group">
                        ...
                        <select name="search_EQ_sendType" class="form-control input-sm select2bs4">
                            <option value="">所有</option><#list allSendTypes as k,v><option value="${k}">${v}</option></#list>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="search_EQ_provider" class="form-control input-sm select2bs4">
                            <option value="">所有</option><#list allProviders as k,v><option value="${k}">${v}</option></#list>
                        </select>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">request_id：</label>
                        <input type="text" class="form-control form-control-sm" name="search_EQ_requestId"/>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">消息编码：</label>
                        <input type="text" class="form-control form-control-sm" name="search_EQ_resultCode"/>
                    </div>
                    <div class="form-group">
  ...
  <div data-options="region:'center',border:false">
    <table id="manage_smsSendLog_datagrid" class="easyui-datagrid" url="/manage/smsend/smsSendLog/listJson.html" toolbar="#manage_smsSendLog_toolbar" fit="true" border="false" fitColumns="false"
      ...
      <thead>
        <tr>
			...
			<th field="requestId">request_id</th>
            <th field="retryCount" sortable="true" sum="true">重试次数</th>
			<th field="resultCode">消息编码</th>
			<th field="resultMessage" formatter="contentFormatter">消息内容</th>
