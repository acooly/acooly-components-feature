...
public interface ShortMessageSender {
    ...
    SmsResult send(List<String> mobileNos, String content, String contentSign);

    default SmsResult send(List<String> mobileNos, String content) {
    ...
    SmsResult sendTemplate(List<String> mobileNos, String templateCode, Map<String, String> templateParams, String contentSign);

    default SmsResult sendTemplate(List<String> mobileNos, String templateCode, Map<String, String> templateParams) {
