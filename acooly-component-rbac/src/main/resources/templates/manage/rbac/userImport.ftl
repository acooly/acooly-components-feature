...
$(function() {
	$.acooly.framework.createUploadify({
				/** 上传导入的URL */
				url:'/manage/rbac/rbacUser/importJson.html?_csrf=${_csrf.token}&splitKey=v',
				/** 导入操作消息容器 */
...
<table class="tableForm" width="100%">
  ...
  <tr>
    ...
    <td><div id="manage_user_import_uploader_message" style="color: red;"></div></td>
  </tr>
  <tr>
    <th width="30%">文件：</th>
    <td>
    <input type="file" name="manage_user_import_uploader_file" id="manage_user_import_uploader_file" />
    </td>
  </tr>
</table>
</div>
