    ...
    <div data-options="region:'center',border:false">
        ...
        <div id="manage_customer_action" style="display: none;">
            <div class="btn-group btn-group-sm">
                <a onclick="$.acooly.framework.edit({url:'/manage/module/test/security/customer/edit.html',id:'{0}',entity:'customer',width:500,height:500});" class="btn btn-primary" href="#" title="编辑"><i class="fa fa-pencil"></i> 编辑</a>
                <a onclick="$.acooly.framework.show('/manage/module/test/security/customer/show.html?id={0}',500,500);" class="btn btn-info" href="#" title="查看"><i class="fa fa-file-o"></i> 查看</a>
                <a onclick="$.acooly.framework.remove('/manage/module/test/security/customer/deleteJson.html','{0}','manage_customer_datagrid');" class="btn btn-danger" href="#" title="删除"><i class="fa fa-trash-o"></i> 删除</a>
            </div>
        </div>
