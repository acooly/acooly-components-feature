                ...
                <tr>
                    <td align="left">角色名称:<input type="text" size="10" name="search_LIKE_name"/>
                        <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true"
                           onclick="$.acooly.framework.search('manage_role_searchform','manage_role_datagrid');">查询</a>
                    </td>
                </tr>
            </table>
        </form>
    ...
    <div data-options="region:'center',border:false">
        <table id="manage_role_datagrid" class="easyui-datagrid" url="${rc.contextPath}/manage/system/role/listJson.html"
            ...
            <tr>
                ...
                <th field="action" data-options="formatter:function(value,row,index){return formatAction('manage_role_action',value,row);}">
                    动作
                </th>
            </tr>
            </thead>
        ...
        <div id="manage_role_action" style="display: none;">
            <a class="line-action icon-edit" title="编辑"
               onclick="$.acooly.framework.edit({url:'/manage/system/role/edit.html',id:'{0}',entity:'role',width:550,height:500});"
               href="#"></a>
            <a class="line-action icon-delete" title="删除"
               onclick="$.acooly.framework.remove('/manage/system/role/deleteJson.html','{0}','manage_role_datagrid');" href="#"></a>
        </div>

        <div id="manage_role_toolbar">
            <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true"
               onclick="$.acooly.framework.create({url:'/manage/system/role/create.html',entity:'role',width:550,height:500});">添加</a>
            <a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain="true"
               onclick="$.acooly.framework.edit({url:'/manage/system/role/edit.html',entity:'role',width:550,height:500});">编辑</a>
            <a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true"
               onclick="$.acooly.framework.removes('/manage/system/role/deleteJson.html','manage_role_datagrid')">批量删除</a>
        </div>
    </div>
