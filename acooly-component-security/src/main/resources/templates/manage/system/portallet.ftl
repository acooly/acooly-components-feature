...
<div class="easyui-layout" data-options="fit : true,border : false">
    ...
    <div data-options="region:'north',border:false" style="padding: 5px; overflow: hidden;" align="left">
        <form id="manage_portallet_searchform" class="form-inline ac-form-search" onsubmit="return false">
            ...
            <div class="form-group">
                <button class="btn btn-sm btn-primary" type="button" onclick="$.acooly.framework.search('manage_portallet_searchform','manage_portallet_datagrid');"><i class="fa fa-search fa-lg fa-fw fa-col"></i> 查询</button>
            </div>
        </form>
    </div>
    ...
    <div data-options="region:'center',border:false">
        <table id="manage_portallet_datagrid" class="easyui-datagrid" url="${rc.contextPath}/manage/system/portallet/listJson.html"
            ...
            <tr>
                ...
                <th field="rowActions" data-options="formatter:function(value, row, index){return formatAction('manage_portallet_action',value,row)}">动作
                </th>
            </tr>
            </thead>
        </table>
        ...
        <div id="manage_portallet_action" style="display: none;">
            <div class="btn-group btn-group-sm">
                <a onclick="$.acooly.framework.edit({url:'/manage/system/portallet/edit.html',id:'{0}',entity:'portallet',height:450,width:600});"
                   class="btn btn-primary" href="#" title="编辑"><i class="fa fa-pencil"></i> 编辑</a>
                <a onclick="$.acooly.framework.remove('/manage/system/portallet/deleteJson.html','{0}','manage_portallet_datagrid',null,null,cleanPortalletCookie);"
                   class="btn btn-info" href="#" title="删除"><i class="fa fa-trash-o"></i> 删除</a>
            </div>
        </div>

        <!-- 表格的工具栏 -->
        <div id="manage_portallet_toolbar">
            <a href="#" class="easyui-linkbutton" plain="true" onclick="$.acooly.framework.create({url:'/manage/system/portallet/create.html',entity:'portallet',height:450,width:600,onSuccess:cleanPortalletCookie})"><i class="fa fa-plus-circle fa-lg fa-fw fa-col"></i>添加</a>
            <a href="#" class="easyui-linkbutton" plain="true" onclick="$.acooly.framework.removes('/manage/system/portallet/deleteJson.html','manage_portallet_datagrid',null,null,cleanPortalletCookie)"><i class="fa fa-trash-o fa-lg fa-fw fa-col"></i>批量删除</a>
        </div>
    </div>
