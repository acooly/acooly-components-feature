            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown notifications-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li class="header">选择主题</li>
                            <li>
                                <!-- inner menu: contains the actual data -->
                                <ul class="top-menu">
                                    <li><a href="/manage/index.html?acoolyTheme=adminlte3">
                                            <i class="fa fa-pie-chart fa-lg" ></i> 创新素雅
                                            <span class="text-right text-sm">AdminLte3</span>
                                        </a></li>
                                    <li><a href="/manage/index.html?acoolyTheme=adminlte">
                                            <i class="fa fa-telegram fa-lg text-primary"></i> 蓝色科技
                                            <span class="text-right text-sm text-primary">AdminLte2</span>
                                        </a></li>
                                    <li><a href="/manage/index.html?acoolyTheme=easyui"><i class="fa fa-bandcamp fa-lg"></i> 原滋原味 <span class="text-right text-sm">EasyUI1.9</span></a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
