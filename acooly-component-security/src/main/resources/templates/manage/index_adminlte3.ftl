...
<head>
    ...
    <style>
        .datagrid-header .datagrid-cell span {
            font-size: ${Session.securityConfig.fontSize}px;
        }

        .datagrid-header-row, .datagrid-row {
            height: <#if Session.securityConfig.fontSize lt 14>35<#else>40</#if>px;
        }
        ...
        .main-sidebar, .main-sidebar::before {
            width: ${Session.securityConfig.mainSidebarWidth}px;
        }

        .content-wrapper, body:not(.sidebar-mini-md) .main-footer, body:not(.sidebar-mini-md) .main-header {
            margin-left: ${Session.securityConfig.mainSidebarWidth}px;
        }
