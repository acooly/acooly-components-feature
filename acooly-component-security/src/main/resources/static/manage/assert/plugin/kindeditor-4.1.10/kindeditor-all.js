    ...
    K.extend(KSWFUpload, {
        init: function (options) {
            ...
            self.div = K(options.container).html([
                ...
                '<div class="ke-inline-block ke-swfupload-button" style="position: absolute;z-index:1000; opacity: 0; left: 0;">',
                '<input type="button" value="Browse" />',
                '</div>',
                '<div style="background-image: url(/manage/assert/plugin/kindeditor/plugins/multiimage/images/select-files-zh_CN.png); height: 23px; width:72px;float:left;"></div>',
