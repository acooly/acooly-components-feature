            ...
            $(_53b).children("thead").each(function () {
                ...
                $(this).find("tr").each(function () {
                    ...
                    $(this).find("th").each(function () {
                        var th = $(this);
                        var col = $.extend({}, $.parser.parseOptions(this, ["sum", "avg", "max", "min", "field", "align", "halign", "order", {
                            sortable: "boolean",
                            checkbox: "boolean",
                            resizable: "boolean",
                            fixed: "boolean"
...
// changed by zhangpu 2017-09-12 start:
            var data = $.data(_6df, "datagrid").data;
// end
            var cc = [];
            ...
            for (var i = 0; i < _6e0.length; i++) {
                ...
                if (col) {
                    ...
                    if (col.checkbox) {
                        ...
                        if (col.formatter) {
                            // changed by zhangpu on 2017-08-12
                            cc.push(col.formatter(_6e6, _6e3, _6e2, data, _6e5));
...
(function ($) {
    function _83e(_83f, _840) {
        ...
        // modify by zhangpu
        _844._outerWidth(opts.width);
        // _842._outerHeight(_844._outerHeight);
        ...
        // _845._outerHeight(_844._outerHeight());
    ...
    function _85f(_860) {
        ...
        function _865() {
            ...
            // modify by zhangpu
            if(_862._outerHeight() == 16) {return top + 10;}
            // modufy end
            return top;
        };
    };
