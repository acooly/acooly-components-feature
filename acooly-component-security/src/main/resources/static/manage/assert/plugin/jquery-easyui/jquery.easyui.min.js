...
},message:"请输入有效的电子邮件地址。"},url:{validator:function(_577){
...
},message:"请输入有效的URL地址。"},length:{validator:function(_578,_579){
var len=$.trim(_578).length;
return len>=_579[0]&&len<=_579[1];
},message:"输入内容长度必须介于{0}和{1}之间。"},remote:{validator:function(_57a,_57b){
var data={};
data[_57b[1]]=_57a;
...
// changed by zhangpu 2020-03-29 for extend formatter supports `mappingFormatter`
// start:
var data = $.data(_8f7, "datagrid").data;
// end
var cc=[];
...
if(col.formatter){
    // changed by zhangpu 2020-03-29 for extend formatter supports `mappingFormatter`
    // start:
    cc.push(col.formatter(_8fe,_8fb,_8fa,data,_8fd));
    // end.
