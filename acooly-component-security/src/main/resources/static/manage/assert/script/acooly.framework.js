    ...
    $.extend($.acooly, {
        framework: {
            ...
            initPlugins: function (container) {
                ...
                // 初始化日期端选择
                $.acooly.framework.daterangepicker();
            },
            ...
            daterangepicker: function () {
                ...
                $('.acooly-daterangepicker').on('apply.daterangepicker', function (ev, picker) {
                    that._on_daterangepicker_apply(picker.element, picker.startDate.format('YYYY-MM-DD'), picker.endDate.format('YYYY-MM-DD'), picker.chosenLabel);
                });
                // 注册取消时间：清理已选择的值
                $('.acooly-daterangepicker').on('cancel.daterangepicker', function (ev, picker) {
                    that._on_daterangepicker_cancel(ev, picker);
                });
             ...
             * @private
             */
            _on_daterangepicker_apply: function (el, startDate, endDate, label) {
            ...
            _on_daterangepicker_cancel: function (ev, picker) {
