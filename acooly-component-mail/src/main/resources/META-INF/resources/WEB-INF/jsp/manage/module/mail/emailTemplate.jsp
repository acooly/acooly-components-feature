...
<script type="text/javascript">
    $(function () {
        $.acooly.framework.registerKeydown('manage_emailTemplate_searchform', 'manage_emailTemplate_datagrid');
    });
...
<div class="easyui-layout" data-options="fit : true,border : false">
    ...
    <div data-options="region:'north',border:false" style="padding:5px; overflow: hidden;" align="left">
        <form id="manage_emailTemplate_searchform" onsubmit="return false">
            <table class="tableForm" width="100%">
                <tr>
                    <td align="left">
                        <div>
                            模版名称: <input type="text" class="text" size="15" name="search_LIKE_name"/>
                            邮件主题: <input type="text" class="text" size="15" name="search_LIKE_subject"/>
                            <a href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:false"
                               onclick="$.acooly.framework.search('manage_emailTemplate_searchform','manage_emailTemplate_datagrid');"><i
    ...
    <div data-options="region:'center',border:false">
        ...
        <div id="manage_emailTemplate_action" style="display: none;">
            <a onclick="$.acooly.framework.edit({url:'/manage/module/mail/emailTemplate/edit.html',id:'{0}',entity:'emailTemplate',width:700,height:600});"
        ...
        <div id="manage_emailTemplate_toolbar">
            <a href="#" class="easyui-linkbutton" plain="true"
               onclick="$.acooly.framework.create({url:'/manage/module/mail/emailTemplate/create.html',entity:'emailTemplate',width:700,height:600})"><i
