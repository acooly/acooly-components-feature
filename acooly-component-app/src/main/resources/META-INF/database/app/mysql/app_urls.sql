INSERT INTO `sys_resource` (`ID`, `PARENTID`, `NAME`, `TYPE`, `SHOW_STATE`, `ORDER_TIME`, `VALUE`, `SHOW_MODE`, `ICON`, `DESCN`) VALUES ('151001', NULL, 'APP组件', 'MENU', '0', '2015-09-28 18:59:46', '', '1', 'fa fa-android', NULL);
