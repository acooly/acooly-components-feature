...
<div class="easyui-layout" data-options="fit : true,border : false">
  ...
  <div data-options="region:'center',border:false">
    <table id="manage_appConfig_datagrid" class="easyui-datagrid" url="${pageContext.request.contextPath}/manage/module/config/appConfig/listJson.html" toolbar="#manage_appConfig_toolbar" fit="true" border="false" fitColumns="false"
      ...
      <thead>
        <tr>
			...
			<th field="configValue" width="500px">配置值</th>
			<th field="comments" width="100px">配置描述</th>
    ...
    <div id="manage_appConfig_action" style="display: none;">
      <a onclick="$.acooly.framework.edit({url:'/manage/module/config/appConfig/edit.html',id:'{0}',entity:'appConfig',width:500,height:400});" href="#" title="编辑"><i class="fa fa-pencil fa-lg fa-fw fa-col"></i></a>
    ...
    <div id="manage_appConfig_toolbar">
      <a href="#" class="easyui-linkbutton" plain="true" onclick="$.acooly.framework.create({url:'/manage/module/config/appConfig/create.html',entity:'appConfig',width:500,height:400})"><i class="fa fa-plus-circle fa-lg fa-fw fa-col"></i>添加</a>
