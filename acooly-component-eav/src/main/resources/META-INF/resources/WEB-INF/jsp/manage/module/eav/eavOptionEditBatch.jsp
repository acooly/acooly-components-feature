...
<div>
    ...
    <form id="manage_eavOption_editform"
        ...
        <div style="margin: 15px;">
            ...
            <a onclick="$.manage.eav.option.append()" class="easyui-linkbutton" href="#" title="添加"><i class="fa fa-plus-circle fa-lg fa-fw fa-col"></i> 添加选项</a>
        </div>
        <table id="manage_eavOption_formlist" class="table-list tableForm" width="100%">
            ...
            <tr>
                <td><input type="text" name="code_${e.id}" value="${e.code}" style="width: 200px" placeholder="选项编码..."
                           class="easyui-validatebox text" data-options="validType:['length[1,64]'],required:true"/>
                </td>
                <td><input type="text" name="name_${e.id}" value="${e.name}" style="width: 200px" placeholder="选项名称..."
                           class="easyui-validatebox text" data-options="validType:['length[1,64]'],required:true"/>
                </td>
                <td>
                    <a onclick="$.manage.eav.option.remove(this);" href="#" title="删除"><i class="fa fa-times-circle fa-lg fa-fw fa-col"></i></a>
    ...
    <script id="manage_eavOption_row_template" type="text/html">
        <tr>
            ...
            <td><input type="text" name="name_{%=id%}" style="width: 200px" placeholder="选项名称..."
                       class="easyui-validatebox text" data-options="validType:['length[1,64]'],required:true"/></td>
            <td>
                <a onclick="$.manage.eav.option.remove(this);" href="#" title="删除"><i
                        class="fa fa-times-circle fa-lg fa-fw fa-col"></i></a>
                <a onclick="" href="#" title="上移"><i class="fa fa-arrow-up fa-lg fa-fw fa-col"></i></a>
                <a onclick="" href="#" title="置顶"><i
                        class="fa fa-step-backward fa-rotate-90 fa-lg fa-fw fa-col"></i></a>
            </td>
        </tr>
    </script>
    <script>
