...
import com.acooly.module.certification.constant.Constants;
import com.acooly.module.certification.constant.HttpHeader;
import com.acooly.module.certification.constant.SystemHeader;
...
public class SignUtil {
    ...
    public static String sign(
        ...
        try {
            ...
            return new String(
                    Base64.encodeBase64(
                            hmacSha256.doFinal(
                                    buildStringToSign(method, path, headers, querys, bodys, signHeaderPrefixList)
    ...
    private static String buildResource(
            String path, Map<String, String> querys, Map<String, String> bodys) {
        StringBuilder sb = new StringBuilder();
